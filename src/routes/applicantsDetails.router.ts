...
import { isPengawasOrInterviewer } from '../middleware/role-middleware';
...
// router.get('/applicant/:applicants_id', protectAuth, isAdmin, ApplicantsDetailsController.listApplicantsDetailsByApplicant);
